...
class TestModuleMeshCorrection:
    ...
    def test_alk_aft_gets_180_rotation(self):
        """ALK_A behind cockpit gets 180° Y rotation with center compensation."""
    ...
    def test_alk_c_aft_gets_180_no_z_offset(self):
        """ALK_C behind cockpit gets 180° Y rotation, no Z-offset."""
